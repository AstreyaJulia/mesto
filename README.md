...
#### Спринт 8 (19.03.2022 - ...):
1. Установлены webpack, webpack-cli и webpack-dev-server, настроены сборки build и dev, настроена минификацию и транспиляцию JS Babel, настроена минификация CSS и автоматическое добавление вендорных префиксов, настроена обработка изображений и шрифтов;
