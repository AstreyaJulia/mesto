...
(Изображения взяты из описаний проектых работ Яндекс.Практикум)
...
12. Валидация форм добавки места и редактирования профиля, не прошедшие валидацию поля подсвечиваются, под ними отображается ошибка валидации;
